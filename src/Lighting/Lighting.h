...
inline void ApplyLights(Shader& shader, const glm::mat4& view, const glm::mat4& projection,
    const std::vector<std::unique_ptr<BaseModel>>& ObjectVector)
{
    ...
    shader.setVec3("SunLight.color", glm::vec3(LightCol[0], LightCol[1], LightCol[2]));
    //shader.setFloat("SunLight.intensity", 0.3f);
    shader.setFloat("SunLight.intensity", LightIntensity);

    shader.setVec3("PointLights[0].position", pointLightPosition);
    shader.setVec3("PointLights[0].color", glm::vec3(LightCol[0], LightCol[1], LightCol[2]));
    //shader.setFloat("PointLights[0].intensity", 1.0f);
    shader.setFloat("PointLights[0].intensity", LightIntensity);
